...
Telegram.in(function(message) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    //add support for the sticker type
    else if (botMsg.sticker != null) {
      type = 'sticker';
      fileId = botMsg.sticker.file_id;
    }
  ...
  return new Promise(function(resolve, reject) {
    ...
    var buttons = {
      reply_markup: JSON.stringify({
        ...
        one_time_keyboard: (message.payload.options && message.payload.options.one_time_keyboard) ? true : false
      }),
      parse_mode: parseMode
    };
    // finally send
